...
public class IndexFileLoader {
    ...
    public void init(){
        ...
        adUnitItStrings.forEach(u -> AdLevelDataHandler.handleLevel4(
                JSON.parseObject(u, AdUnitItTable.class),
                OpType.ADD
        ));
        ...
        adUnitKeywordStrings.forEach(u -> AdLevelDataHandler.handleLevel4(
                JSON.parseObject(u, AdUnitKeywordTable.class),
                OpType.ADD
        ));
