...
public class CreativeUnitIndex implements IndexAware<String, CreativeUnitObject> {
    private static Map<String, CreativeUnitObject> objectMap; // <adId-unitId, CreativeObject>
    private static Map<Long, Set<Long>> creativeUnitMap; // <adId, unitId Set>
    private static Map<Long, Set<Long>> unitCreativeMap; // <unitId, adId Set>
    static {
