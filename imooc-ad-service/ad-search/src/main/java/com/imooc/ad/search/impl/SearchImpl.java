...
public class SearchImpl implements ISearch {
    ...
    public SearchResponse fallbakc(SearchRequest req, Throwable e) {
        return null;
    }
    @Override
    @HystrixCommand(fallbackMethod = "fallbakc")
    public SearchResponse fetchAds(SearchRequest request) {
        ...
        Map<String, List<SearchResponse.Creative>> adSlot2Ad = response.getAdSlot2Ads();
    ...
    private void filterKeywordFeature(Collection<Long> adUnitIds, KeywordFeature keywordFeature) {
        ...
        if(CollectionUtils.isNotEmpty(keywordFeature.getKeywords())) {
            CollectionUtils.filter(
                    adUnitIds,
                    adUnitId ->
                            DataTable.of(UnitKeywordIndex.class).match(adUnitId,
    ...
    private void filterDistrictFeature(Collection<Long> adUnitIds, DistrictFeature districtFeature) {
        ...
        if(CollectionUtils.isNotEmpty(districtFeature.getDistricts())) {
            CollectionUtils.filter(
                    adUnitIds,
                    adUnitId ->
                            DataTable.of(UnitDistrictIndex.class).match(adUnitId,
